...
static void
rs_alive_ratio_lower_handler(const vector_t * strvec)
{
	virtual_server_t *vs = LIST_TAIL_DATA(check_data->vs);
...
static void
rs_alive_ratio_upper_handler(const vector_t * strvec)
{
	virtual_server_t *vs = LIST_TAIL_DATA(check_data->vs);
...
static void
rs_alive_ratio_action_handler(const vector_t *strvec)
{
	virtual_server_t *vs = LIST_TAIL_DATA(check_data->vs);
